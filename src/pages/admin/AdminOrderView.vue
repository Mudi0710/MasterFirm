      ...
      <q-dialog v-model="detailDialog.dialog" seamless style="width: auto;">
        <q-card square class="row justify-center bg-info q-pa-lg" style="width: 100%;">
          ...
          <div class="row q-pa-md" style="width: 100%; border: 1px solid #1E1918;">
            ...
            <!-- 訂購會員 -->
            <div class="col-12 row">
              <div class="col-12 col-sm-auto text-h6 text-accent">訂購會員：</div>
              <div class="col-12 col-sm-auto text-sm-h6 text-dark">{{ detail.row.user.account }}</div>
            </div>
            <!-- 訂單日期 -->
            <div class="col-12 row">
...
const columns = [
  ...
  { name: 'account', label: '訂購會員', field: row => row.user.account, required: true, align: 'center' },
