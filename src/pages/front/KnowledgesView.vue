    ...
    <div id="mycontent" class="col row justify-start">
      ...
      <div class="col-12 q-mt-md q-pl-lg" style="width: 100%;">
        <q-breadcrumbs>
          ...
          <q-breadcrumbs-el label="靈學知識" icon="fa-regular fa-lightbulb" />
        </q-breadcrumbs>
      </div>
      ...
      <div id="knowledges-content" class="col-12 row justify-between q-mt-md" style="height: auto;">
        ...
        <div id="knowledges-img" class="col-12 col-xl-5 q-pa-md" style="height: auto;">
          <q-carousel animated infinite swipeable transition-prev="slide-right" transition-next="slide-left"
            ...
            <q-carousel-slide
              v-for="(knowledgesImageMobile, idx) in carousels.length > 0 ? carousels[0]?.knowledgesImageMobile : ''"
              :key="knowledgesImageMobile" :name="idx + 1" :img-src="knowledgesImageMobile" />
          </q-carousel>
          <q-carousel animated infinite swipeable transition-prev="slide-right" transition-next="slide-left"
            ...
            <q-carousel-slide
              v-for="(knowledgesImageDesktop, idx) in carousels.length > 0 ? carousels[0]?.knowledgesImageDesktop : ''"
              :key="knowledgesImageDesktop" :name="idx + 1" :img-src="knowledgesImageDesktop" />
          </q-carousel>
        </div>
